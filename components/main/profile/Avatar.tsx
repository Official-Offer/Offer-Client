  ...
  return (
    <AvatarWrapper>
      ...
      <div className="avatar-button">
        {" "}
        <Heart color={!showFavDapp ? "#1DBBBD" : 'white'} size={20} strokeWidth="2.7px" style={{marginRight:20}}/>
        Favorite Dapps
      </div>
      <div className="avatar-button-active">
        <Settings color={!showFavDapp ? "white" : '#1DBBBD'} size={20} strokeWidth="2.7px" style={{marginRight:20}}/>
        Profile Settings
      </div>
    </AvatarWrapper>
  );
