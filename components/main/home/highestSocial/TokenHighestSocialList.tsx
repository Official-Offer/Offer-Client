          ...
          <tbody>
            {data.map((token: any, i: number) => {
              ...
              return (
                <tr
                  key={i}
                  // onClick={() => router.push(`/app/${token.attributes.slug}`)}
                >
                  ...
                  <td className="main-homepage-highestsocial-table-24users">
                    ...
                    <div
                      className={`main-homepage-highestsocial-table-${userDiff} text-end`}
                    >
                      <p>
                  ...
                  <td className="main-homepage-highestsocial-table-24transactions">
                    ...
                    <div
                      className={`main-homepage-highestsocial-table-${transactionsDiff} text-end`}
                    >
                      <p>
                  ...
                  <td className="main-homepage-highestsocial-table-24volume">
                    <div className="main-homepage-highestsocial-table-24volume-bar-top">
                      ...
                      <div
                        className={`main-homepage-highestsocial-table-${volumeDiff} ms-3`}
                      >
                        <p>
                  ...
                  <td className="main-homepage-highestsocial-table-social">
                    <div>
                      ...
                      <div
                        className={`main-homepage-highestsocial-table-${socialSignalDiff} text-end`}
                      >
                        <p>
                          {(
        ...
        <div className="main-homepage-highestsocial-table mobile">
          <div className="main-homepage-highestsocial-table-header">
            <div className="main-homepage-highestsocial-table-header-item">
              <span className="main-homepage-highestsocial-table-header-item-title">
                #
              </span>
            </div>
            <div className="main-homepage-highestsocial-table-header-item">
                  ...
                  <div className="row m-0 p-0 justify-content-between w-100">
                    ...
                    <div className="col-5">
                      <div className="w-100">
                        <div className="main-homepage-highestsocial-table-body-item-user-number text-end">
                          <p>
                            {valueSelected === "dailyTransaction" ? (
                              token.attributes.dailyTransaction
                            ) : valueSelected === "dailyVolume" ? (
                              `$${formatter.format(
                                token.attributes.dailyVolume
                              )}`
                        ...
                        <div
                          className={`main-homepage-highestsocial-table-${
                            valueSelected === "dailyTransaction"
                              ? transactionsDiff
                              : valueSelected === "dailyVolume"
                              ? volumeDiff
                        ...
                        >
                          <p className="mb-0">
                            {valueSelected === "dailyTransaction" ? (
                              <>
                                {(
                                  token.attributes.dailyTransactionDiff * 100
                                ).toFixed(2)}
                                % {transactionsDiff === "increase" ? "↑" : "↓"}
                              </>
                            ) : valueSelected === "dailyVolume" ? (
                              <>
                                {(
                                  token.attributes.dailyVolumeDiff * 100
                                ).toFixed(2)}
                                % {volumeDiff === "increase" ? "↑" : "↓"}
                              </>
                            ) : valueSelected === "socialSignal" ? (
                              ...
                              <>
                                {(token.attributes.dailyUserDiff * 100).toFixed(
                                  2
                                )}
                                % {userDiff === "increase" ? "↑" : "↓"}
                              </>
                      ...
                      <div className="w-100">
                        <BoxALignCenter_Justify_ItemsEnd>
                          <img
                            ...
                            src={token.attributes.crawl.chains[0].icon_new}
                            alt=""
                          />
                        </BoxALignCenter_Justify_ItemsEnd>
                        <BoxALignCenter_Justify_ItemsEnd>
                          <img
                            className="blockchain-logo"
                            src={token.attributes.crawl.category.icon}
                            alt=""
                          />
                        </BoxALignCenter_Justify_ItemsEnd>
                      </div>
